...
from motion import vel_control
from PID import PI_controller
...
class Brain():
    ...
    def __init__(self):
        ...
        # K_p = (1/(self.robot_speed*2))/self.vision.CAMERA_WIDTH
        # K_i = 1e-5
    ...
    def search_2(self, color_index):
        ...
        while(self.pillar_center[color_index] is None):
            ...
            if found_center[color_index] is not None:
                while(found_center[color_index] > -75 and found_center[color_index] < 75):
                    found_center = self.vision.get_center()
    ...
    def go_2(self, color_index):
        ...
        if(self.lidar.get_frontal_dist() > 1.25):
            ...
            while(self.lidar.get_frontal_dist() > 1.25):
                ...
                center    = self.vision.get_center()[color_index]
                max_error = self.vision.CAMERA_WIDTH/2
                PID_input = center/max_error

                # PID control loop
                w = self.PI_angular_vel(PID_input)
